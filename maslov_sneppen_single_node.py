...
--------------------------
  TableS6_EAS_all_tissues.csv
  TableS6_EUR_all_tissues.csv

Usage
-----
  python maslov_sneppen_single_node.py

  To replot a previously saved result without re-running:
...
TISSUE_MAP = [
    ...
    # EUR population
    ("EUR", "Ovary",     "crosstalk_edges_EUR_ovary.csv",     "CDK9"),
    ("EUR", "Adipose",   "crosstalk_edges_EUR_adipose.csv",   "SUOX"),
    ("EUR", "Liver",     "crosstalk_edges_EUR_liver.csv",     "CYCS"),
    ("EUR", "Muscle",    "crosstalk_edges_EUR_muscle.csv",    "CDK2"),
    ("EUR", "Pancreas",  "crosstalk_edges_EUR_pancreas.csv",  "IRF1"),
    ("EUR", "Pituitary", "crosstalk_edges_EUR_pituitary.csv", "EP300"),
    ("EUR", "Cortex",    "crosstalk_edges_EUR_cortex.csv",    "CDK1"),
]
